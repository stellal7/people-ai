...
- Changing anything under PLANTED SIGNALS in `src/people_ai/synthetic/params.py` means updating the schema doc and `tests/test_planted_signals.py` in the same commit.
